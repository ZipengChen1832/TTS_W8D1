...
public class Library {
    ...
    public void borrowBook(String bookName){
        ...
        for(Book book : books){
            if(book.title.equals(bookName)){
                if(book.isBorrowed()) System.out.println("Sorry, this book is already borrowed.");
                else{
    ...
    public void printAvailableBooks(){
        if(books.isEmpty()) System.out.print("No book in catalog ");
        else for(Book book : books) {
            if(!book.isBorrowed()) System.out.println(book.title);
        }
